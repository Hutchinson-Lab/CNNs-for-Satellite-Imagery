...
def get_paths(task):
	paths = {
		'treecover': {
			'home_dir': '/nfs/stak/users/hopkilau/final/',
			#'img_dir': '/nfs/hpc/share/hopkilau/datadrive/mosaiks/data/png/contus_uar/',
			'img_dir': '/nfs/hpc/share/hopkilau/datadrive/mosaiks/data/png/contus_uar_128/',
			...
			'means': '/nfs/stak/users/hopkilau/final/channel_means/channel_means_contus_uar_Apr-06-2022.txt',
		},

		'nightlights': {
			'home_dir': '/nfs/stak/users/hopkilau/final/',
			'img_dir': '/nfs/hpc/share/hopkilau/datadrive/mosaiks/data/png/contus_pop_128/',
			...
			'means': '/nfs/stak/users/hopkilau/final/channel_means/channel_means_contus_pop_Nov-16-2022.txt',
		},
		...
		'landuse': {
			...
			'means': '/nfs/stak/users/hopkilau/final/channel_means/channel_means_ucMerced_landuse_Jan-05-2023.txt',
		},
		...
		'residential': {
			...
			'means': '/nfs/stak/users/hopkilau/final/channel_means/channel_means_ucMerced_residential_Jan-10-2023.txt',
		},
		...
		'coffee': {
			...
			'means': '/nfs/stak/users/hopkilau/final/channel_means/channel_means_coffee_Aug-18-2024.txt',
		},
		...
		'eurosat': {
			...
			'means': '/nfs/stak/users/hopkilau/final/channel_means/channel_means_eurosat_ms_Jul-01-2024.txt',
		}
	}
